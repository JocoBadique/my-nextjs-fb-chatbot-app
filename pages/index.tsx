...
export default function Home() {
 ...
 <Head>
    <title>My Next.js Chatbot</title>
 </Head>
      ...
      <div className="w-full md:w-1/2 md:px-3">
        <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          ...
          <div className="relative flex flex-col sm:flex-row sm:space-x-4">
           <Link href="/"><a className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
              Try It Free
            ...
            <Link href="/"><a className="flex items-center px-6 py-3 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600">
              Learn More
            </a></Link>
          </div>
        </div>
